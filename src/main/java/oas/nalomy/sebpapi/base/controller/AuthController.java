package oas.nalomy.sebpapi.base.controller;
...
import oas.nalomy.sebpapi.base.domain.User;
...
import oas.nalomy.sebpapi.base.security.service.UserDetailsImpl;
		...
		if (strRoles == null) {
			...
			strRoles.forEach(role -> {
				...
				case "admin":
					...
					break;
				case "gestor":
					Role gestorRole = roleRepository.findByName(ERole.ROLE_GESTOR)
							.orElseThrow(() -> new RuntimeException("Error: Role is not found."));
					roles.add(gestorRole);

					break;
				case "leitor":
					Role leitorRole = roleRepository.findByName(ERole.ROLE_LEITOR)
							.orElseThrow(() -> new RuntimeException("Error: Role is not found."));
